 ...
 * @author GBorisHP
 */
public class reg_director extends javax.swing.JFrame {

    /**
     * Creates new form reg_director
     */
    public reg_director() {
        initComponents();
    }
    String generatePassword = RandomPassword.generateRandomPassword(8);
    public void reg_director(){
        int respuesta = 0;
    ...
    public void buscar(){
        ...
        if( !user.get(0).getNombreRol().equals("DIRECTOR") ){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reg_director.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new reg_director().setVisible(true);
            }
        });
    }
